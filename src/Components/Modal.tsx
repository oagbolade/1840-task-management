...
export const Modal = () => {
  return (
      <div><div className="flex items-center justify-center h-screen">
          <button className="py-2 px-6 bg-blue-500 text-white rounded hover:bg-blue-700 transition font-medium duration-500" onclick="toggleModal()">SHOW MODAL</button>
      </div>
              ...
              <div className="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                  ...
                  <div className="inline-block align-center bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                      ...
                      <div className="bg-gray-200 px-4 py-3 text-right">
                          ...
                          <button type="button" className="py-2 px-4 bg-blue-500 text-white rounded font-medium hover:bg-blue-700 mr-2 transition duration-500"><AddIcon /> Create</button>
                      </div>
                  </div>
              </div>
          </div></div>
